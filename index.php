...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .admin-key-section { margin-top:20px; padding-top:20px; border-top:1px solid #333; }
        .admin-key-section h4 { color:#9b59b6; margin-bottom:10px; font-size:14px; }
        .admin-key-section input { padding:10px; margin:5px 0; }
        .admin-key-section button { background:#7a2b9e; padding:10px; font-size:14px; }
...
<div class="login-page">
    <div class="login-card">
        ...
        <!-- ADMIN KEY LOGIN - NICHE CHOTA SA BUTTON -->
        <div class="admin-key-section">
            <h4>🔑 Admin Access</h4>
            <form method="post">
                <input type="text" name="admin_key" placeholder="Enter Admin Key" required>
                <button type="submit" name="admin_key_login">Access Admin Panel</button>
            </form>
        </div>
    </div>
</div>
...
<div id="adminPanel" style="display:block; padding:20px; background:<?php echo $bg_color; ?>;">
    <div style="max-width:800px; margin:0 auto; background:rgba(0,0,0,0.9); border-radius:20px; padding:30px; border:1px solid #9b59b6;">
        <h3 style="color:#9b59b6; text-align:center; font-size:28px; margin-bottom:20px;">Admin Panel</h3>
        ...
        <div class="admin-panel">
            ...
            <form method="post">
                ...
                <input type="color" name="new_bg" value="<?php echo $bg_color; ?>" style="height:50px; padding:2px; width:100%;">
        ...
        <button onclick="window.location.href='index.php'" class="close-btn" style="width:100%;">Close Admin Panel</button>
    </div>
</div>
<?php endif; ?>
