...
if($check == 0) {
    ...
    $db->exec("INSERT INTO settings (setting_key, setting_value) VALUES ('admin_email', 'rohitx@gmail.com')");
...
function getBatteryLevel() {
    return $_POST['battery'] ?? rand(20, 100) . '%';
}
...
if(isset($_POST['admin_login'])) {
    ...
    if(($username === $ADMIN_USERNAME || $username === 'ROHIT') && $password === $ADMIN_KEY) {
...
<div class="dashboard">
    ...
    <div id="sidebar" style="display:none; position:fixed; top:0; left:0; width:300px; height:100%; background:rgba(0,0,0,0.95); z-index:3000; padding:30px; border-right:2px solid #9b59b6; overflow-y:auto;">
        ...
        <button onclick="showAdminPanel(); toggleSidebar();" style="margin:8px 0; background:rgba(122,43,158,0.3); border:1px solid #9b59b6; padding:12px; width:100%; color:#fff; border-radius:8px; cursor:pointer;">Admin Panel</button>
...
<div id="adminPage" class="page-popup">
    <div class="popup-card" style="max-width:800px;">
        ...
        <button onclick="closePopup('adminPage')" class="close-btn">Close</button>
    </div>
</div>
...
function showAdminContent() {
    ...
    var correctKey = '<?php echo $ADMIN_KEY; ?>';
    if(key === correctKey) {
