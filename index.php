...
// ============ ADMIN LOGIN VIA KEY (to admin.php) ============
...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .admin-key-section h4 { color:#9b59b6; margin-bottom:10px; font-size:13px; letter-spacing:1px; }
        .admin-key-section input { padding:10px; margin:5px 0; font-size:13px; }
        .admin-key-section button { background:#7a2b9e; padding:10px; font-size:13px; width:100%; }
        .admin-key-section button:hover { background:#9b59b6; }
...
<div class="login-page">
    <div class="login-card">
        ...
        <!-- ADMIN ACCESS - Login page pe niche -->
